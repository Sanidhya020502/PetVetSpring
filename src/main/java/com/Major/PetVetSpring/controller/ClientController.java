...
import com.Major.PetVetSpring.services.client.ClientService;
...
public class ClientController {
	...
	public ResponseEntity<?> searchAdByService(@PathVariable String city){
		return ResponseEntity.ok(clientService.searchAdByCity(city));
	}
